...
from metis_app.models.brain_graph import BrainNode
...
brain_canvas = pytest.importorskip("metis_app.views.brain_canvas", reason="Qt runtime unavailable")
