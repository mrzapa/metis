...
_CATALOG_PACKAGE = "metis_app.assets"
...
class LocalLlmRecommenderService:
    ...
    def default_models_dir(self, settings: dict[str, Any] | None = None) -> pathlib.Path:
        ...
        if os.name == "nt":
            ...
            return pathlib.Path(base) / "METIS" / "models" / "gguf"
        if platform.system().lower() == "darwin":
            return pathlib.Path("~/Library/Caches/METIS/models/gguf").expanduser()
        return pathlib.Path("~/.cache/metis/models/gguf").expanduser()
