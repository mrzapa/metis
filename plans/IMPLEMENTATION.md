...
**Last reviewed:** 2026-04-24 (M10 row reconciled to `Landed` after PR #529 merge `95480be`, 2026-04-22 — the plan doc was already flipped to Landed and the shipped code lives in `cc3923f` + `6fa1ff2`. M17 Phase 7 landed via PR #527 merge `3cde870`, 2026-04-21 — M17 row reconciled from `In progress (Phase 7 claimed)` to `Landed`; Phase 8 (Tauri-layer enforcement) remains a declared v2 stretch. Prior 2026-04-20 pass reconciled stale-ready M03/M04/M05/M06 rows to Landed after a code-vs-plan audit, and reconciled M17 Phase 6 landed via PR #525). See [`Prompt agents.md`](Prompt%20agents.md) for the onboarding prompt to give a fresh agent.
...
| M10 | **Tribev2 homological scaffold** — persistent homology over BrainGraph | 🌱🌌 | Landed | [`plans/trive-v2-homological-scaffold/plan.md`](trive-v2-homological-scaffold/plan.md) | Landed via PR #529 (`95480be`, 2026-04-22); implementation shipped in `cc3923f` + `6fa1ff2` | 2026-04-24 | — |
