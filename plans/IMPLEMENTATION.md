...
| M17 | **Network audit** — outbound call panel, per-provider block, offline proof | 🔧 | In progress | [`plans/network-audit/plan.md`](network-audit/plan.md) | Phases 1-6 landed (PRs #516-#521, #525 merge `3969170`); `claude/m17-phase7-export-discoverability` working Phase 7 — CSV export endpoint + first-run discoverability card + coordination-hooks docs | 2026-04-20 | — |
