...
| M12 | **Interactive star catalogue** — searchable, filterable star explorer | 🌌 | Ready | [`plans/interactive-star-catalogue/plan.md`](interactive-star-catalogue/plan.md) (supersedes `docs/plans/2026-04-05-interactive-star-catalogue.md`) | claude/m12-plan-and-claim (Phase 0 — plan drafted; data layer landed via PR #513, renderer via M02; interactive explorer layer still unshipped) | 2026-04-24 | — |
| M13 | **Seedling + Feed** — always-on quantized local model, news-comet ingestion, growth stages | 🌱 | In progress | [`plans/seedling-and-feed/plan.md`](seedling-and-feed/plan.md) | `claude/m13-phase6-brain-graph-densification` | 2026-04-26 | M01 |
