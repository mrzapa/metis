...
| M23 | **Companion controls** — tone presets + memory inspector in `/settings → Companion`; closes Shape of AI gaps #1 + #2 | 🌱 | Ready | [`plans/companion-controls/plan.md`](companion-controls/plan.md) (design: [`docs/plans/2026-05-03-companion-controls-design.md`](../docs/plans/2026-05-03-companion-controls-design.md)) | — | 2026-05-03 | M13 |
