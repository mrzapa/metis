...
| M03 | **IterRAG convergence** — agentic loop with convergence detection | 🧠 | In progress | [`docs/plans/2026-04-01-hermes-sotaku-implementation.md`](../docs/plans/2026-04-01-hermes-sotaku-implementation.md) (Phase 1) | `codex/m03-phase1-iterrag-convergence` (Phase 1 — convergence settings, helpers, loop wiring, tests) | 2026-04-20 | — |
