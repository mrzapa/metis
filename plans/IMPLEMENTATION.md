...
**Last reviewed:** 2026-04-22 (M17 Phase 7 landed via PR #527 merge `3cde870`, 2026-04-21 — M17 row reconciled from `In progress (Phase 7 claimed)` to `Landed`; Phase 8 (Tauri-layer enforcement) remains a declared v2 stretch. Prior 2026-04-20 pass reconciled stale-ready M03/M04/M05/M06 rows to Landed after a code-vs-plan audit, and reconciled M17 Phase 6 landed via PR #525. M10 row reconciliation outstanding — plan.md was flipped to Landed via PR #529 but the table row still reads Draft; left for a separate PR to keep this change minimal). See [`Prompt agents.md`](Prompt%20agents.md) for the onboarding prompt to give a fresh agent.
...
| M10 | **Tribev2 homological scaffold** — persistent homology over BrainGraph | 🌱🌌 | Draft | [`plans/trive-v2-homological-scaffold/plan.md`](trive-v2-homological-scaffold/plan.md) | claude/m10-reconcile-table-row | 2026-04-24 | — |
