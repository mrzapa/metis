...
| M17 | **Network audit** — outbound call panel, per-provider block, offline proof | 🔧 | In progress | [`plans/network-audit/plan.md`](network-audit/plan.md) | Phases 1-3 landed (`ddd2db2`); `claude/m17-phase4-sdk-events` working Phase 4 — LangChain SDK invocation-layer events + kill-switch enforcement at PooledLLM.invoke | 2026-04-19 | — |
