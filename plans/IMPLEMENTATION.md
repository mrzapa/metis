...
| M14 | **The Forge** — technique gallery UI, togglable frontier modules | 🌱🧠 | In progress | [`plans/the-forge/plan.md`](the-forge/plan.md) | Phases 1–6 landed (PRs #575–#585; Phase 4c `e841e38`, Phase 6 `15da54e`); Phase 7 (stretch — `.metis-skill` export) remaining; claude/jovial-volhard-3fa662 reconciling | 2026-05-01 | M02, M06, M12 |
...
| M16 | **Personal evals** — track companion improvement on user's specific tasks | 🌱 | In progress | [`plans/personal-evals/plan.md`](personal-evals/plan.md) | claude/m16-phase2-eval-store (Phase 1 ADRs landed via PR #594, `a9e57c6`, 2026-05-01) | 2026-05-01 | M13 |
