...
| M24 | **Constellation IA reset (UI)** — kill faculty anchors, content-cluster placement, AI-suggested Add flow, central-star Everything chat | 🌌 | Landed | [`plans/constellation-ia-reset/plan.md`](constellation-ia-reset/plan.md) (design: [`docs/plans/2026-05-03-constellation-ia-reset-design.md`](../docs/plans/2026-05-03-constellation-ia-reset-design.md), ADR: [`docs/adr/0019-constellation-ia-content-first-projects.md`](../docs/adr/0019-constellation-ia-content-first-projects.md)) | Landed via [PR #614](https://github.com/mrzapa/metis/pull/614) (`0cf696ae`, 2026-05-03) — 41 commits, 6 phases + 6 review-response commits + Phase-4 stretch (showConceptAtNode + activeNodeRef cleanup). Vitest 763/10, backend pytest 1630/12, tsc clean. Browser-preview QA pending on main repo per [Task 6.5](../docs/plans/2026-05-03-constellation-ia-reset-m24-implementation.md). Faculty-ring rendering preserved for comet/RAG/focus consumers until M26 | 2026-05-03 | — |
