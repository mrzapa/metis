...
| M02 | **Constellation 2D refactor** — retire 3D sphere, 2D archetype dive (ADR 0006) | 🌌 | In progress | [`plans/constellation-2d-refactor/plan.md`](constellation-2d-refactor/plan.md) | `claude/m02-archetypes-nebula-bh-rg` (Phase 3: 5/12 archetypes) — Phases 0/0.3/1/2/3-scaffold landed | 2026-04-18 | — |
