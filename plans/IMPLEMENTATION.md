...
| M24 | **Constellation IA reset (UI)** — kill faculty anchors, content-cluster placement, AI-suggested Add flow, central-star Everything chat | 🌌 | In progress | [`plans/constellation-ia-reset/plan.md`](constellation-ia-reset/plan.md) (design: [`docs/plans/2026-05-03-constellation-ia-reset-design.md`](../docs/plans/2026-05-03-constellation-ia-reset-design.md), ADR: [`docs/adr/0019-constellation-ia-content-first-projects.md`](../docs/adr/0019-constellation-ia-content-first-projects.md)) | claude/m24-phase1-clustering (Phase 1 backend clustering — `StarClusteringService` + `get_star_clusters` + `GET /v1/stars/clusters` + 14 tests; PR pending) | 2026-05-03 | — |
