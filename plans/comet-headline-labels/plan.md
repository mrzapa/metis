...
- ~~**Phase 4 — Collision suppression.**~~ Shipped via PR #595 on 2026-05-01. `rotatedLabelBbox` + `suppressCollidingLabels` + prepare/suppress/draw pipeline; +12 unit tests. Highest-relevance comet wins when AABBs overlap >40%.
