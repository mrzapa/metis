...
- **Decision:** **Audit ran 2026-05-02; gaps #1 + #2 promoted as M23 on 2026-05-03.** Full per-pattern scorecard + prioritised top-10 gap list at [`docs/preserve-and-productize-plan.md` → *Shape of AI pattern audit (2026-05-02)*](../docs/preserve-and-productize-plan.md). **Promoted:** gap #1 *Voice and tone + Personality* + gap #2 *Memory inspector* bundled as **M23 — Companion controls** ([`plans/companion-controls/plan.md`](companion-controls/plan.md), design at [`docs/plans/2026-05-03-companion-controls-design.md`](../docs/plans/2026-05-03-companion-controls-design.md), ~4 days now that backend infrastructure is largely in place). **Awaiting go/no-go (Merge into M21):** gap #3 *Caveat strip per mode*, gap #4 *Disclosure on AI-generated content*, gap #9 *Regenerate* (all P3-shaped polish). **Already in M21 under different names:** gap #5 *Filters that work* (= M21 #13) and gap #6 *Sample response / model-load progress* (= M21 #9) — re-tag with Shape-of-AI vocabulary when picked up. **Awaiting go/no-go (Park or Merge):** gap #7 *Action plan* (Park or Merge into M16), gap #8 *Incognito Mode* (Park or Merge into M17), gap #10 *Inline Action* (Park).
