"""axiom_app.utils.document_loader — Format-aware document text extraction.
...
::
    ...
    from axiom_app.utils.document_loader import load_document, is_kreuzberg_available
...
try:
    ...
    _log.debug(
        "kreuzberg not installed — install with: pip install 'axiom-app[kreuzberg]'"
    )
