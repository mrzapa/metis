...
import axiom_app.settings_store as settings_store
...
from axiom_app.services.runtime_resolution import (
...
class AssistantCompanionService:
        ...
        *,
        ...
        links: list[AssistantBrainLink] = [
            AssistantBrainLink.create(
                source_node_id="assistant:axiom",
    ...
    def _heuristic_reflection(
        ...
        *,
        ...
        summary = "Axiom recorded a new local reflection."
        ...
        if session_detail is not None:
            ...
            summary = (
                f"Axiom noticed a {mode} conversation"
        ...
        if trigger == "onboarding":
            ...
            summary = "Axiom welcomed the user and prepared a lightweight local companion flow."
            ...
            summary = "Axiom noticed a new index and recorded a follow-up suggestion for grounded exploration."
