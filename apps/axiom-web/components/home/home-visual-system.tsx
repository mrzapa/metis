...
const ICON_BASE_CLASS =
  "relative flex items-center justify-center overflow-hidden rounded-full border border-white/10 bg-[radial-gradient(circle_at_50%_35%,rgba(173,198,255,0.16),rgba(10,14,22,0.88)_72%)] shadow-[0_10px_30px_rgba(0,0,0,0.24),inset_0_1px_0_rgba(255,255,255,0.12)]";
...
function LogoGlow() {
  return (
    <>
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -inset-8 rounded-full bg-[#0969da]/18 blur-3xl"
      />
      <span
        aria-hidden="true"
        className="pointer-events-none absolute inset-1 rounded-full bg-[radial-gradient(circle_at_50%_35%,rgba(173,198,255,0.26),rgba(8,11,18,0.95)_72%)]"
      />
    </>
  );
}
  ...
  return (
    <div className={cn("relative isolate", className)}>
      ...
      <Image
        ...
        priority={priority}
        className="relative z-10 size-full object-contain drop-shadow-[0_0_42px_rgba(9,105,218,0.34)]"
      />
    </div>
  );
}
