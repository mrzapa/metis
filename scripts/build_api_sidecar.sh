...
# places it at apps/metis-desktop/src-tauri/binaries/metis-api-{target-triple},
# which is the naming convention Tauri v2 requires for externalBin sidecar
# binaries.
#
...
pyinstaller \
  ...
  "${REPO_ROOT}/metis_app/api_litestar/__main__.py"
